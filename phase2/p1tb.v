...
module tb();
    ...
    initial begin
        ...
        // Preload the 4 instructions into RAM (Addresses 0, 4, 8, 12)
        // Format: [31:27 Opcode] [26:22 Ra] [21:17 Rb] [16:0 c]
        // Case 1 & 3: Ra=R7(0111), Rb=R0(0000), c=0x65 -> Hex: 0x03800065
        dp.ram.memory[0] = 32'h03800065; 
        dp.ram.memory[8] = 32'h03800065; 

        // Case 2 & 4: Ra=R0(0000), Rb=R2(0010), c=0x72 -> Hex: 0x00100072
        dp.ram.memory[4] = 32'h00100072;
        dp.ram.memory[12]= 32'h00100072;

        // Release clear to start the state machine
        #20 clear = 0;

        // Preload R2 as required for Cases 2 and 4
