`include "core/alu/logic.v"
`include "core/alu/neg.v"
`include "core/alu/adder.v"
`include "core/alu/mul.v"
`include "core/alu/div.v"
`include "core/alu/rol.v"
`include "core/alu/ror.v"
`include "core/alu/shl.v"
`include "core/alu/shr.v"
`include "core/alu/shra.v"
...
CLA32 add(A, B, 1'b0, Z_add, cout_add);
CLA32 sub(A, B, 1'b1, Z_sub, cout_sub);
