`include "phase3/core/registers.v"
`include "phase3/core/Bus.v"
`include "phase3/core/CONFF.v"
`include "phase3/core/SelectEncode.v"
`include "phase3/core/ram.v"
`include "phase3/core/control.v"
`include "phase3/core/alu/alu.v"
...
RAM #(.INIT_FILE("phase3/core/instructions.mem")) l1_icache(
    .clock(clock),
...
RAM #(.INIT_FILE("phase3/core/data.mem")) l1_dcache(
    .clock(clock),
    .read(RAMread),
    .write(RAMwrite),
    .address(MAROut),
